...
def ocr(request, printer, arquivo):
    ...
    try:
        ...
        pasta_destino = os.path.join(model.pasta_dig+ '/temp/')
        
        print "copiando arquivo para pasta temporária"
        shutil.copy2(arquivo_original, pasta_destino)
